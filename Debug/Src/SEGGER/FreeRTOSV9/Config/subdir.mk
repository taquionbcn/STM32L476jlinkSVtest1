...
C_SRCS += \
../Src/SEGGER/FreeRTOSV9/Config/SEGGER_SYSVIEW_Config_FreeRTOS.c 

OBJS += \
./Src/SEGGER/FreeRTOSV9/Config/SEGGER_SYSVIEW_Config_FreeRTOS.o 

C_DEPS += \
./Src/SEGGER/FreeRTOSV9/Config/SEGGER_SYSVIEW_Config_FreeRTOS.d 


# Each subdirectory must supply rules for building sources it contributes
Src/SEGGER/FreeRTOSV9/Config/%.o: ../Src/SEGGER/FreeRTOSV9/Config/%.c
	@echo 'Building file: $<'
